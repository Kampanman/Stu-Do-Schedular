...
<body>
  <!-- Vue Area -->
  <div id="vueArea">
    <div :style="styles.mg1ems"><br></div>
    <!-- メッセージエリア -->
      ...
      <div id="loginFormArea" class="fader">
        <login-card-sec>
          ...
          <template #contents>
            ...
            ></v-text-field>
            <div align="center">
              <p v-if="loginJudge == 'fail'" :style="styles.redPointer" @click="loginJudge = ''">{{ message.loginFail }}</p>
              <p v-if="loginJudge == 'passError'" :style="styles.redPointer" @click="loginJudge = ''">{{ message.passwordInvalid }}</p>
              <p v-if="loginJudge == 'stopped'" :style="styles.redPointer" @click="loginJudge = ''">{{ message.stoppedAccount }}</p>
              <p v-if="loginJudge == 'success'" style="color:#0082ff;">{{ message.loginSuccess }}</p>
  ...
  <script type="module">
    ...
    import loginCardSection from '../static/js/VJCP_loginCardSection.js';
